...
// SwaggerErrorMessage standardized error response.
...
// SwaggerSuccessfullyMessage structure that returns successfully
...
// SwaggerMap is a convenient way to create objects of unknown types.
